...
class OfferStatusChangerTests(BaseTestCase):
    ...
    def test_delete_user_created(self):
        ...
        self.assertEqual(settings.STATUS_DELETED, offer.status.id)
    ...
    def test_delete_user_that_not_attached(self):
        ...
        self.assertEqual(settings.STATUS_AWAITING_ACCEPTANCE, offer.status.id)
    ...
    def test_accept_user_that_not_attached(self):
        ...
        self.assertEqual(settings.STATUS_AWAITING_APPROVAL, offer.status.id)
    ...
    def test_approve_user_created(self):
        ...
        self.assertEqual(settings.STATUS_READY_TO_EXCHANGE, offer.status.id)
    ...
    def test_complete_user_created(self):
        ...
        self.assertEqual(settings.STATUS_FINISHED, offer.status.id)
